...
namespace Kingshot.Gameplay
{
    ...
    public sealed class PlayerMovement : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (controller == null || inputReader == null)
            {
                Debug.LogError("PlayerMovement requires CharacterController and PlayerInputReader.", this);
            }

            if (cameraTransform == null)
            {
                Debug.LogError("PlayerMovement could not resolve the Main Camera transform.", this);
            }
        }
